...
public class TypeEffect extends StatusEffect {
	...
	private static final long serialVersionUID = -3279292817876635213L;
	...
	/**
	 * Computes the Interaction between two StatusEffects.
	 * Considers just TypeEffects.
	 * 
	 * Modifies the duration of the Effect between same RobotActionTypes 
	 * or creates a new StatusEffect
	 * 
	 * Resistance + Vulnerability = No Status Effect
	 * Vulnerability + Vulnerability = Longer Duration
	...
	public StatusEffect resolveInteractionWith(StatusEffect otherStatusEffect) {
		...
		// sub duration
			...
			{
				resolvedTypeEffect = new TypeEffect(this.actionType, otherTypeEffect.getModificationType(), computedDuration*-1);
			}
		}
