...
public class BattleController
{
	...
	public BattleController(DataLoader loader)
	{
		...
		this.cinematicVisualizer.reset();
	}
	...
	private void regenerateEnergyOfRobots(Robot robotLeft, Robot robotRight, int energyReg)
	{
		...
		robotLeft.setEnergyPoints(Math.min(energyRobotLeft, robotLeft.getMaxEnergyPoints()));
		robotRight.setEnergyPoints(Math.min(energyRobotRight, robotRight.getMaxEnergyPoints()));
